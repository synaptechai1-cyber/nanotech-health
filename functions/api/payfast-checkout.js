...
export async function onRequestPost({ request, env }) {
  try {
    ...
    const fields = {
      ...
      // PAYFAST_NOTIFY_URL_OVERRIDE is a temporary diagnostic knob — see
      // SETUP.md "If subscriptions never activate" section. Leave unset
      // in normal operation.
      notify_url: env.PAYFAST_NOTIFY_URL_OVERRIDE || `${siteUrl}/api/payfast-notify`,
